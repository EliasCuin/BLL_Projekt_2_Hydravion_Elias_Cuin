...
# Diese Datei ermöglicht die Simulation des Spiels
# Mithilfe der Funktionen (startVisualisation, startVisualisation) kann auch eine Visualisierung mittels PyGame
# des Spiels erfolgen.

class Environment():
  def __init__(self):
    # REWARDS:
    self.iceBergCollisionReward = -1000
    self.getCoinReward = 2
  ...
  def visualiseCurrentFrame(self):
